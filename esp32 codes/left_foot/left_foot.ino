...
// BLE UUIDs
#define SERVICE_UUID "4fafc201-1fb5-459e-8fcc-c5c9c331914b" // Note the last character changed
#define CHARACTERISTIC_UUID "beb5483e-36e1-4688-b7f5-ea07361b26a8" // Note the last character changed
...
void setup() {
  ...
  pinMode(sensorPin4, INPUT); // Initialize fourth sensor

  // Initialize BLE
  BLEDevice::init("ESP32_Sensor_1"); // Unique name for Device 1
